        ...
        <div className="bg-gray-950 min-h-screen lg:h-[calc(100vh-64px)] overflow-hidden flex flex-col lg:flex-row">
            ...
            <div className="flex-1 relative bg-black group overflow-hidden">
                ...
                <div className="absolute top-8 left-8 flex items-center gap-4 z-20">
                    <div className="flex items-center gap-3 bg-black/40 backdrop-blur-2xl p-2.5 pl-2.5 pr-5 rounded-2xl border border-white/10 shadow-2xl">
                        <img 
                ...
                <div className="absolute top-8 right-8 flex items-center gap-3 z-20">
                    <button className="w-12 h-12 bg-black/40 backdrop-blur-2xl rounded-2xl text-white hover:bg-orange-500 transition-all flex items-center justify-center border border-white/10 shadow-2xl">
                        <Share2 size={20} />
                    </button>
                    <button onClick={() => navigate('/livestream')} className="w-12 h-12 bg-black/40 backdrop-blur-2xl rounded-2xl text-white hover:bg-red-500 transition-all flex items-center justify-center border border-white/10 shadow-2xl">
                        <X size={20} />
                    </button>
                </div>
                ...
                {currentStream.productId && (
                    <div className="absolute bottom-10 left-8 z-20 w-full max-w-sm animate-in fade-in slide-in-from-bottom-8 duration-700">
                        <div 
                            onClick={() => navigate(`/product/${currentStream.productSlug}`)}
                            className="bg-white/95 backdrop-blur-3xl p-5 rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.3)] flex items-center gap-5 border border-white/20 cursor-pointer hover:bg-white transition-all transform hover:-translate-y-2 group"
                        >
                            <div className="w-20 h-20 rounded-2xl overflow-hidden shadow-inner flex-shrink-0 bg-gray-50 border border-gray-100 p-2">
                ...
                {/* Heart/Like Action */}
                <div className="absolute bottom-10 right-8 flex flex-col gap-4 z-20">
                    <button className="w-14 h-14 bg-gradient-to-br from-pink-500 to-rose-600 rounded-2xl flex items-center justify-center text-white shadow-2xl shadow-pink-500/20 hover:scale-110 active:scale-95 transition-all">
            ...
            {/* Chat Section */}
            <div className="w-full lg:w-[400px] bg-gray-900 flex flex-col border-l border-white/5 shadow-2xl z-30 relative">
                <div className="p-6 border-b border-white/5 flex items-center justify-between bg-gray-900/50 backdrop-blur-xl">
                ...
                <div className="p-6 bg-gray-900/80 backdrop-blur-xl border-t border-white/5">
                    <form onSubmit={handleSendMessage} className="relative">
                        <input 
                            type="text" 
                            className="w-full bg-gray-800 text-white border border-white/5 rounded-2xl py-4 pl-5 pr-14 focus:ring-2 focus:ring-orange-500/50 outline-none placeholder:text-gray-500 font-medium transition-all"

...
const Register = () => {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center py-3 sm:py-8 px-3 sm:px-4 lg:px-8 bg-gradient-to-br from-[#f7f7f7] to-white/50">
        ...
        <div className="w-full lg:w-1/2 p-5 sm:p-8 md:p-12">
          <div className="max-w-[440px] mx-auto w-full">
            <div className="mb-8 sm:mb-10 text-center lg:text-left">
              <h1 className="text-2xl sm:text-3xl font-black text-secondary-800 tracking-tight">Đăng ký tài khoản</h1>
              <p className="text-sm sm:text-base text-gray-400 mt-2 font-medium">Khám phá vũ trụ công nghệ cùng chúng tôi.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full h-14 pl-12 pr-4 py-3.5 bg-gray-50 border border-transparent rounded-2xl focus:bg-white focus:border-primary-MAIN focus:ring-4 focus:ring-primary-MAIN/10 transition-all outline-none font-medium text-secondary-800"
                  />
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  minLength={6}
                  className="w-full h-14 pl-12 pr-12 py-3.5 bg-gray-50 border border-transparent rounded-2xl focus:bg-white focus:border-primary-MAIN focus:ring-4 focus:ring-primary-MAIN/10 transition-all outline-none font-medium text-secondary-800"
                />
                <button
                  type="button"
            ...
            <div className="mt-8 sm:mt-10 pt-6 sm:pt-8 border-t border-gray-100 flex flex-col items-center gap-4">
              ...
              <p className="text-[10px] sm:text-[11px] text-gray-400 text-center uppercase tracking-widest leading-relaxed sm:leading-loose">
                Bằng cách đăng ký, bạn đồng ý với <br className="hidden sm:block" />
